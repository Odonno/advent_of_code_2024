...
pub type Plant = String

pub type GardenMap = Dict(Position, Plant)
...
pub fn extract_region_positions(current_area: Set(Position), plant: Plant, map: GardenMap) -> Set(Position) {
    let next_area = current_area
        |> set.to_list
