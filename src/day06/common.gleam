...
pub type GuardMap = Dict(Position, MapCellType)
pub type VisitedGuardPositionMap = Dict(Position, Bool)

pub type Guard = #(Position, Direction)

pub type VisitedGuardMap = Dict(Guard, Bool)
